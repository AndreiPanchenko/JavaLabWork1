...
Программа предоставляет интерактивное меню для навигации между разделами и задачами, с проверкой ввода и удобным интерфейсом. Все методы реализованы в классе `Methods` и вызываются через его экземпляр.
...
- **`Methods.java`** - содержит все методы для решения задач (нестатические)
- **`Main.java`** - содержит главное меню и логику взаимодействия с пользователем

### Особенности архитектуры:
- Используется объектно-ориентированный подход (нестатические методы)
- Реализована обработка ошибок ввода пользователя
...
```
**Принцип работы:** Использует цикл for и StringBuilder для построения строки.
...
- Нормальные случаи ввода
- Граничные условия
- Ошибочные входные данные
- Пустые массивы и специальные случаи

Программа демонстрирует надежную работу и соответствует всем поставленным требованиям.
