        ...
        do {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    while (!scanner.hasNextInt()) {
                        System.out.println("Ошибка! Введите целое число от 1 до 7.");
                        scanner.next();
                    }
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    int[] arr = Methods.parseArray(line);
                ...
                case 2:
                    ...
                    int[] arr2 = Methods.parseArray(line2);
                ...
                case 3:
                    ...
                    while (mainLine.trim().isEmpty()) {
                        System.out.println("Ошибка: массив не может быть пустым!");
                        System.out.println("Введите основной массив (через пробел):");
                        mainLine = scanner.nextLine();
                    }
                    int[] mainArr = Methods.parseArray(mainLine);
                    System.out.println("Введите массив для вставки (через пробел):");
                    String insLine = scanner.nextLine();
                    while (insLine.trim().isEmpty()) {
                        System.out.println("Ошибка: массив не может быть пустым!");
                        System.out.println("Введите массив для вставки (через пробел):");
                        insLine = scanner.nextLine();
                    }
                    int[] insArr = Methods.parseArray(insLine);
                ...
                case 4:
                    ...
                    while (line3.trim().isEmpty()) {
                        System.out.println("Ошибка: массив не может быть пустым!");
                        System.out.println("Введите массив (через пробел):");
                        line3 = scanner.nextLine();
                    }
                    int[] arr3 = Methods.parseArray(line3);
                ...
                case 5:
                    ...
                    while (line4.trim().isEmpty()) {
                        System.out.println("Ошибка: массив не может быть пустым!");
                        System.out.println("Введите массив (через пробел):");
                        line4 = scanner.nextLine();
                    }
                    int[] arr4 = Methods.parseArray(line4);
                    System.out.print("Введите искомый элемент: ");
                    while (!scanner.hasNextInt()) {
                        System.out.println("Ошибка! Введите целое число.");
                        scanner.next();
